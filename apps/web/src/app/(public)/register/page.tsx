      ...
      <div style={{ maxWidth: '400px', margin: '0 auto', padding: '2rem' }}>
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h1 style={{ fontSize: '2rem', marginTop: '1rem', color: '#00FF88' }}>Request Invite</h1>
            <p style={{ color: '#B8C0CC', marginTop: '0.5rem' }}>Join the BlackRatio community</p>
          </div>
          ...
          <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', color: '#F0F0F0' }}>Confirm Password</label>
              <input 
                type="password" 
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', color: '#F0F0F0' }}>Invite Code</label>
              <input 
                type="text" 
          ...
          <div style={{ textAlign: 'center', marginTop: '2rem' }}>
            <p style={{ color: '#B8C0CC', fontSize: '0.9rem' }}>
              ...
              <a href="/login" style={{ color: '#00FF88', textDecoration: 'none' }}>Sign in</a>
            </p>
          </div>
        </div>
      </div>
